...
G) Constructing your own functions: Unless you are in the cutting edge or face redundant operations or handle similar datasets, then it worth the time to write. R package functions provide greater protection against faultyy code
